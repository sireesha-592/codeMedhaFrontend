...
const styles = {
  ...
  card:      { background: '#fff', padding: '2.5rem', borderRadius: '16px', width: '380px', boxShadow: '0 20px 60px rgba(0,0,0,0.3)' },
  ...
  input:     { width: '100%', padding: '11px 14px', margin: '7px 0', borderRadius: '10px', border: '1.5px solid #e2e8f0', fontSize: '14px', boxSizing: 'border-box', outline: 'none', fontFamily: 'inherit' },
  button:    { width: '100%', padding: '13px', marginTop: '1rem', color: '#fff', border: 'none', borderRadius: '10px', fontSize: '15px', fontWeight: 700, cursor: 'pointer' },
